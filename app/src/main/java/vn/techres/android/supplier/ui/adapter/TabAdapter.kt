package vn.techres.android.supplier.ui.adapter
...
import vn.techres.android.supplier.app.AppAdapter
import vn.techres.android.supplier.databinding.TabItemDesignBinding
import vn.techres.android.supplier.databinding.TabItemSlidingBinding
...
class TabAdapter @JvmOverloads constructor(
    ...
    inner class SlidingViewHolder(val binding: TabItemSlidingBinding) : AppViewHolder(binding.root),
        ...
        private val mDefaultTextSize: Int by lazy {
            getResources().getDimension(vn.techres.android.supplier.R.dimen.sp_14).toInt()
        }
        private val mSelectedTextSize: Int by lazy {
            getResources().getDimension(vn.techres.android.supplier.R.dimen.sp_15).toInt()
        }
