...
import vn.techres.android.supplier.other.GlideEngine
...
object PhotoPickerUtils {
    ...
    private fun styleSelector(context: Context) {
        ...
        whiteTitleBarStyle.titleDrawableRightResource =
            vn.techres.android.supplier.R.drawable.ic_arrow_down_orange
        whiteTitleBarStyle.titleLeftBackResource = vn.techres.android.supplier.R.drawable.ic_back_gray_group
        ...
        whiteBottomNavBarStyle.bottomPreviewSelectTextColor =
            ContextCompat.getColor(context, vn.techres.android.supplier.R.color.orange_700)
